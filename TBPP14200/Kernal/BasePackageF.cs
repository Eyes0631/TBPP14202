...
namespace TBPP14200
{
    public partial class BasePackageF : Form
    {
        ...
        #region 架構使用 (Public)
        public virtual void RefreshFormObjs() 
        {
        }
        ...
        {
            SYSPara.LogSay(EnLoggerType.EnLog_OP, string.Format("User Click「Finish」-[{0}Set]", ModuleName));
        ...
        private void btnEdit_Click(object sender, EventArgs e)
        {
            ...
            SYSPara.LogSay(EnLoggerType.EnLog_OP, string.Format("User Click「Edit」-[{0}Set]", ModuleName));
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            if (cansave)
            {
                SYSPara.LogSay(EnLoggerType.EnLog_OP, string.Format("User Click「Save」-[{0}Set]", ModuleName));
        ...
        {
            SYSPara.LogSay(EnLoggerType.EnLog_OP, string.Format("User Click「Cancel」-[{0}Set]", ModuleName));
        ...
        {
            SYSPara.LogSay(EnLoggerType.EnLog_OP, string.Format("User Click「Rename」-[Package Set]"));
        ...
        {
            SYSPara.LogSay(EnLoggerType.EnLog_OP, "User Click「Delete」-[Package Set]");  //產品刪除
