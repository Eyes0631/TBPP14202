...
namespace TBPP14200
{
    public partial class ModuleContainerForm : Form
    {
        ...
        {
            //儲存操作按鈕資訊
            SYSPara.LogSay(EnLoggerType.EnLog_OP, "User Click Module -『 " + ((Button)sender).Text + " 』Button");
            ...
            ((BaseModuleInterface)obj).ShowPage(SYSPara.mSecret.NowUser); //20210701 kent
