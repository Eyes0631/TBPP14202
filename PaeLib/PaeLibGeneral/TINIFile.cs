...
{
    /// <summary>
    /// This class is VCL Like TINIFile in C++ (Author: atowngit)
    /// </summary>
    public class TINIFile : IDisposable
    {
        ...
        public string ReadString(string Section, string Key, string DefaultValue)
        {
            ...
            try
            {
                sbResult = new StringBuilder(1024);//Poyao 增加Read string大小
                GetPrivateProfileString(Section, Key, "", sbResult, 1024, this._FilePath);
